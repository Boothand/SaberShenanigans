...
int WeaponReadyAnim[WP_NUM_WEAPONS] =
{
	...
	TORSO_WEAPONREADY3,//TORSO_WEAPONREADY2,//WP_BRYAR_PISTOL,	//Boot - hold the bryar like you would hold a blaster.
...
int WeaponAttackAnim[WP_NUM_WEAPONS] =
{
	...
	BOTH_ATTACK3,//BOTH_ATTACK2,//WP_BRYAR_PISTOL,	//Boot - shoot a bryar like you would shoot a blaster.
